        ...
        <div class="account-page">
            <div class="account-center">
                <div class="account-box">
                    ...
                    <form @submit.prevent="register()" class="form-signin" @keydown="clear($event.target.name)">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="full_name" v-model="admin.full_name" class="form-control">
                            <p class="help is-danger" style="color: red;">@{{ getSignupError('full_name') }}</p>
                        </div>
                        <div class="form-group">
                            <label>Username</label>
                            <input type="text" name="username" v-model="admin.username" class="form-control">
                            <p class="help is-danger" style="color: red;">@{{ getSignupError('username') }}</p>
                        </div>
                        <div class="form-group">
                            <label>Email Address</label>
                            <input type="email" name="email" v-model="admin.email" class="form-control">
                            <p class="help is-danger" style="color: red;">@{{ getSignupError('email') }}</p>
                        </div>
                        <div class="form-group">
                            <label>Password</label>
                            <input type="password" name="password" v-model="admin.password" class="form-control">
                            <p class="help is-danger" style="color: red;">@{{ getSignupError('password') }}</p>
                        </div>
                        <div class="form-group">
                            <label>Password Again</label>
                            <input type="password" name="password_confirmation" v-model="admin.password_confirmation" class="form-control">
                            <p class="help is-danger" style="color: red;">@{{ getSignupError('password_confirmation') }}</p>
                        </div>
                        <div class="form-group">
                            <label>Mobile Number</label>
                            <input type="text" name="mobile" v-model="admin.mobile" class="form-control">
