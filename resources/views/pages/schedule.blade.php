        ...
        <div class="content">
            <div class="row">
                ...
                <div class="col-sm-8 col-9 text-right m-b-20">
                    <a href="{!! url('user/add-schedule') !!}" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Schedule</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="table-responsive">
                        ...
                        <table class="table table-border table-striped custom-table mb-0">
                            ...
                            <tr>
                                <td><img width="28" height="28" src="assets/img/user.jpg" class="rounded-circle m-r-5" alt="">{{ $sched->full_name }}</td>
                                <td>{{ $sch->name }}</td>
                        ...
                        @else
                            <div class="alert alert-info">You have no registered schedules </div>
                        @endif
